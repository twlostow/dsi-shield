...
#define CSR_HPDMC_SYSTEM	(BASE_IOREGS+0x00030000)

#define HPDMC_SYSTEM_BYPASS	(0x01)
#define HPDMC_SYSTEM_RESET	(0x02)
#define HPDMC_SYSTEM_CKE	(0x04)

#define CSR_HPDMC_BYPASS	(BASE_IOREGS+0x00030004)
...
#define CSR_HPDMC_TIMING	(BASE_IOREGS+0x00030008)
...
#define CSR_HPDMC_IODELAY	(BASE_IOREGS+0x0003000C)
