...
#define FB_SIZE 	(BASE_IOREGS+0x040008)
#define FB_MIXCTL 	(BASE_IOREGS+0x04000c)
#define FB_EDID 	(BASE_IOREGS+0x040010)
#define FB_PLL_STATUS 	(BASE_IOREGS+0x040014)
...
void *framebuffer =(void *) BASE_SDRAM;
int fb_width;
int fb_height;
